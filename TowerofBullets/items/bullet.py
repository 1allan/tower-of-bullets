...
class Bullet(Entity):
    ...
    def __init__(self, surface: pygame.Surface, position: tuple, destination, args):
                #  size: tuple, damage: int, speed: int, destination: tuple,
                #  image_file: str=IMAGE):
                 
        super().__init__(surface, position, args['SIZE'], speed=args['SPEED'],
                         image_file='misc/projectiles/' + args['IMAGE_FILE'])
